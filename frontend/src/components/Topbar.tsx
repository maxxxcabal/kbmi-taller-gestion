...
export function Topbar() {
  ...
  return (
    <div className="h-[54px] border-b border-[var(--border)] flex items-center px-6 gap-4 shrink-0 bg-[var(--sidebar)] w-full sticky top-0 z-30">
      <div className="flex items-center gap-2">
        <div className="w-6 h-6 rounded bg-[var(--accent-dim)] flex items-center justify-center text-[var(--accent)]">
          <Wrench size={14} />
        </div>
        <div className="text-[15px] font-extrabold text-[var(--text)] tracking-[-0.3px]">
      ...
      <div className="ml-auto flex items-center gap-[10px]">
        ...
        {/* Search Box */}
        <div className="flex items-center gap-2 bg-[var(--bg)] border border-[var(--border)] rounded-lg px-3 py-1.5 focus-within:border-[var(--accent)] transition-all group">
